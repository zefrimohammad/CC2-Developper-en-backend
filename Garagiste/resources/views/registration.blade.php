...
@section('content')
    <div class="container" style="margin-bottom: 7rem;">
        ...
        <form action="{{ route('registration.post') }}" method="POST" class="m-auto rounded p-5 shadow-lg"
            ...
            <button type="submit" class="btn btn-secondary mb-3 mt-3">Sign Up</button>
            <a class="text-decoration-none text d-block" href="{{ route('login') }}">Already have an account? Log in</a>
